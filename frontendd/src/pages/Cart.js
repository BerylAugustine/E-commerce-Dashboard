...
export default function Cart({ cartItems, setCartItems }) {
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    <div class="col-4 col-lg-3">
                                        <img src={item.product.images[0]} alt={item.product.name} height="90" width="115" />
                                    </div>
    ...
    </Fragment> : (!complete ? <div className='cart-empty'><h2 className='mt-5 '>Your Cart is Empty!</h2></div>
        : <Fragment>
            <div className='order'>
                <div className='order-complete'>
                <h2 className='mt-0'>Order Complete!</h2>
                <p>Your order has been placed succesfully.</p></div>
            </div>
        </Fragment>)
}